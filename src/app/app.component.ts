import {Component, OnDestroy, Renderer2, OnInit, NgZone, ViewChild} from '@angular/core';
import { AuthenticationService } from './_services/authentication.service';
import { ChatService } from './shared/services/fw-chat/chat.service';
...
export class AppComponent implements OnDestroy, OnInit {
    ...
    // @ViewChild('appTopbar') appTopbar: AppTopBarComponent;
    ...
    ngOnInit() {
      ...
      // this.appTopbar.getNotification();
    }
    ...
    onToggleMenuClick(event: Event) {
       // alert('--onToggleMenuClick1--');
       // alert(this.layoutMode);
